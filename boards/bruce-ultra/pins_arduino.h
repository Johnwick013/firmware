...
// Bruce Ultra Compact — provisional pinout (see pcbs/Bruce_Ultra_Compact/PINMAP.md)
// Do NOT flash this env onto Reaper / other hardware until PCB matches.
...
// LF 125 kHz UART frontend
#define RFID125_RX_PIN 2
...
#define SPI_SS_PIN 11 // ST25R3916 NFC CS
...
// NRF24 (E01-2G4M27SX → dedicated 2.4 SMA)
...
// IO EXPANDER — RF path enables for external antennas / PA bias
...
// Optional LoRa footprint (DNP on v1)
